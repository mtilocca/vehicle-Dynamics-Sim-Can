...
struct PlantState {
    ...
    double tau_drive_fl_nm = 0.0;   // Drive torque front-left (Nm)
    ...
    void accept_fields(Visitor& visitor) const {
        // === VEHICLE DYNAMICS (J1939 PGN 0xFF50 SA 0xF0: VEHICLE_STATE_1) ===
        ...
        // === STEERING (J1939 PGN 0xFF21 SA 0x2A: STEER_STATE) ===
        ...
        // === WHEELS (J1939 PGN 0xFF20 SA 0x2A: WHEELS_1) ===
